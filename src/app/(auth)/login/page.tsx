    ...
    <main className="min-h-[100dvh] flex flex-col bg-white">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 pb-20">
        <div className="w-full max-w-sm mx-auto">
          ...
          >
            <h1 className="text-[28px] font-semibold text-[#0a0a0a]">登录</h1>
            <p className="mt-1 text-[14px] text-[#a3a3a3]">欢迎回来</p>
          </motion.div>
          ...
          >
            还没有账号？{' '}
            <Link href="/register" className="text-[#0a0a0a] font-medium">注册</Link>
          </motion.p>
        </div>
      </div>
    </main>
